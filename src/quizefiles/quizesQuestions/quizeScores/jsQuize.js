...
import Questions from "./jsJson.json";
...
<h1 className="cssTitle">Js Quize</h1>
     ...
     <div className="HtmlQuize">
         ...
         <label className="Jsquestion">{item.question}</label>
      ...
      <button className="JssubmitBtn" onClick={this.handleCongrats}>Submit</button>
      {
        this.state.showCongratsPopup && (
          <div className="Popup">
           ...
           <div className="JsScoreBox">

          
          <p>Your Score: {this.state.finalScore}</p>
          <button className="Jsok" onClick={this.handleCancelPoup} >Ok</button>
